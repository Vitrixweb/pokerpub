...
function mostrarOpcoes(opcao) {
	...
	document.getElementById('opcaoSec5').style.display = 'none';
	...
	} else if (opcao === 'opcao5') {
		document.getElementById('opcaoSec5').style.display = 'block';
	}
}
...
document.getElementById("btnEnviar").addEventListener("click", function (event) {
    ...
    if (!todosPreenchidos || dropdownSecundarioCorrespondente.value === "") {
		...
		document.getElementById("btnEnviar").addEventListener("click", function (event) {
			...
			abrirChat(nameValue, firstOption, secOption);
		});

		function abrirChat(nameValue, firstOption, secOption) {
			var numeroTelefone = "14997978691"; //Aqui a gente põe o número do whats do dono do site rs
			let mensagem;
				mensagem = `Olá, me chamo ${nameValue}. Gostaria de garantir meu Stack de ${secOption} para a próxima mesa ${firstOption}.`;
